...
**Navigate to the Instruqt lab using [this](http://mdb.link/instruqt-agents-lab) link.** Fill out the form that appears and click **Submit and access**.
...
The notebook for this lab, namely `ai-agents-lab.ipynb`, should have automatically opened up in the Code Editor upon startup.
