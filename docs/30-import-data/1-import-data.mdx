...
<Screenshot url="https://play.instruqt.com" src="img/screenshots/30-import-data/1-import-data/1-verify-collections.png" alt="Verify collection" />

Click the **>** arrow next to each collection and note the number of documents in it.

<Screenshot url="https://play.instruqt.com" src="img/screenshots/30-import-data/1-import-data/2-full-collection.png" alt="Verify full collection document count" />

<Screenshot url="https://play.instruqt.com" src="img/screenshots/30-import-data/1-import-data/3-embedded-collection.png" alt="Verify embedded collection document count" />